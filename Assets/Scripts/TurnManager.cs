...
public class TurnManager : MonoBehaviour
{
    ...
    {
        bool playerAlive = UnitManager.Instance.AllUnits.Exists(u =>
            u.faction == FactionManager.PlayerFaction && u.currentHP > 0);
        bool enemyAlive = UnitManager.Instance.AllUnits.Exists(u =>
            u.currentHP > 0 &&
            FactionManager.Instance != null &&
            FactionManager.Instance.GetRelation(FactionManager.PlayerFaction, u.faction) == FactionManager.RelationType.Enemy);
